...
class AdminartikelSemua extends StatefulWidget {
  const AdminartikelSemua({super.key});

  @override
  State<AdminartikelSemua> createState() => _AdminartikelSemuaState();
}

// ignore: camel_case_types
class _AdminartikelSemuaState extends State<AdminartikelSemua> {
