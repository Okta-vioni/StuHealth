...
class AdminArtikelTidur extends StatefulWidget {
  const AdminArtikelTidur({super.key});

  @override
  State<AdminArtikelTidur> createState() => _AdminArtikelTidurState();
}

// ignore: camel_case_types
class _AdminArtikelTidurState extends State<AdminArtikelTidur> {
  ...
  void initState() {
    ...
    artikelStream = FirebaseFirestore.instance
        .collection('artikel')
        .where('kategori', isEqualTo: 'Gangguan Tidur')
        .snapshots();
  }
