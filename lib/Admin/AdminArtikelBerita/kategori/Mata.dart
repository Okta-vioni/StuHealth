...
class AdminArtikelMata extends StatefulWidget {
  const AdminArtikelMata({super.key});

  @override
  State<AdminArtikelMata> createState() => _AdminArtikelMataState();
}

// ignore: camel_case_types
class _AdminArtikelMataState extends State<AdminArtikelMata> {
  ...
  void initState() {
    ...
    artikelStream = FirebaseFirestore.instance
        .collection('artikel')
        .where('kategori', isEqualTo: 'Kesehatan Mata')
        .snapshots();
  }
