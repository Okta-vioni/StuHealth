...
import 'package:pbl_stuhealth/Admin/AdminArtikelBerita/kategori/GayaHidupSehat.dart';
...
class AdminArtikelPencernaan extends StatefulWidget {
  const AdminArtikelPencernaan({super.key});

  @override
  State<AdminArtikelPencernaan> createState() => _AdminArtikelPencernaanState();
}

// ignore: camel_case_types
class _AdminArtikelPencernaanState extends State<AdminArtikelPencernaan> {
  ...
  void initState() {
    ...
    artikelStream = FirebaseFirestore.instance
        .collection('artikel')
        .where('kategori', isEqualTo: 'Gangguan Pencernaan')
        .snapshots();
  }
