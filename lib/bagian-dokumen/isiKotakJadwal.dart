...
class isiKotakJadwal extends StatefulWidget {
  final String documentId;
  const isiKotakJadwal({super.key, required this.documentId});

  @override
  State<isiKotakJadwal> createState() => _isiKotakJadwalState();
}

// ignore: camel_case_types
class _isiKotakJadwalState extends State<isiKotakJadwal> {
  @override
  void initState() {
    super.initState();
