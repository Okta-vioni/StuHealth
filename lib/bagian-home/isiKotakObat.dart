...
class UserIsiKotakInfoObat extends StatefulWidget {
  final String documentId;
  const UserIsiKotakInfoObat({super.key, required this.documentId});

  @override
  State<UserIsiKotakInfoObat> createState() => _UserIsiKotakInfoObatState();
}

class _UserIsiKotakInfoObatState extends State<UserIsiKotakInfoObat> {
  @override
  void initState() {
    super.initState();
              ...
              leading: IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const InfoObatVitamin(),
                      ));
                },
                icon: const Icon(
                  Icons.arrow_back,
