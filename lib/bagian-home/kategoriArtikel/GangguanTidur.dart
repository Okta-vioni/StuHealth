...
class UserArtikelTidur extends StatefulWidget {
  const UserArtikelTidur({super.key});

  @override
  State<UserArtikelTidur> createState() => _UserArtikelTidurState();
}

// ignore: camel_case_types
class _UserArtikelTidurState extends State<UserArtikelTidur> {
