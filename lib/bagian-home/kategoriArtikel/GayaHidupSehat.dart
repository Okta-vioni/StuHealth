...
class UserArtikelGaya extends StatefulWidget {
  const UserArtikelGaya({super.key});

  @override
  State<UserArtikelGaya> createState() => _UserArtikelGayaState();
}

// ignore: camel_case_types
class _UserArtikelGayaState extends State<UserArtikelGaya> {
