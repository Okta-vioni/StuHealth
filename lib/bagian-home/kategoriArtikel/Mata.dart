...
class UserArtikelMata extends StatefulWidget {
  const UserArtikelMata({super.key});

  @override
  State<UserArtikelMata> createState() => _UserArtikelMataState();
}

// ignore: camel_case_types
class _UserArtikelMataState extends State<UserArtikelMata> {
