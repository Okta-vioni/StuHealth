...
class UserArtikelPencernaan extends StatefulWidget {
  const UserArtikelPencernaan({super.key});

  @override
  State<UserArtikelPencernaan> createState() => _UserArtikelPencernaanState();
}

// ignore: camel_case_types
class _UserArtikelPencernaanState extends State<UserArtikelPencernaan> {
